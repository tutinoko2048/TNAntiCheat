...
type CustomPermission = CustomPermissionCallback | {
  permissionLevel?: CommandPermissionLevel;
  onVerify: CustomPermissionCallback;
};
type CustomPermissionCallback = (origin: CommandOrigin) => boolean | {
  error: string;
};
type Command = {
...
type CommandCallback<PARAMS extends CommandParams> = (params: { [K in keyof PARAMS]: PARAMS[K] extends [infer T] ? T extends ParamType ? GetParamValue<T> | undefined : never : PARAMS[K] extends ParamType ? GetParamValue<PARAMS[K]> : never }, origin: CommandOrigin) => CustomCommandResult | CustomCommandStatus;
...
//#endregion
export { BlockCommandOrigin, Command, CommandCallback, CommandEnum, CommandHandler, CommandOrigin, CommandRegistrationData, CustomPermission, CustomPermissionCallback, EntityCommandOrigin, NPCCommandOrigin, ParamTypeMap, PlayerCommandOrigin, ServerCommandOrigin, commandHandler, createEnum, failure, success };